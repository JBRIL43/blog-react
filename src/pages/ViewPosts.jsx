      ...
      try {
        ...
        await Promise.all(
          res.data.map(async (post) => {
            try {
              const likedRes = await api.get(`/posts/${post.id}/has-liked`, {
                headers: {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <Button
            ...
            className="max-w-1/10 flex items-center gap-3"
          >
            <svg
              className="w-5 h-5"
              fill="none"
              ...
              <div className="flex items-center justify-center bg-white/5 h-40">
                ...
                >
                  ...
                  <path
                    ...
                    strokeLinejoin="round"
                  />
                  <circle cx="24" cy="20" r="4" stroke="#fff" strokeWidth="2" />
                </svg>
              </div>
              {/* Title and excerpt */}
                ...
                <div className="flex flex-col items-end gap-1">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <Button
                      ...
                      disabled={likeLoading[post.id]}
                      className={`w-1/2 h-10 flex items-center justify-center gap-2 pl-2 pr-2 ${
                        likedPosts[post.id]
                          ? "text-pink-400"
                          : "text-gray-300 hover:text-pink-400"
                      }`}
                      title={likedPosts[post.id] ? "Unlike" : "Like"}
                    >
                      {likedPosts[post.id] ? (
                        // Filled heart SVG (red)
                        <svg
                          className="h-5 w-5"
                          fill="currentColor"
                          viewBox="0 0 20 20"
