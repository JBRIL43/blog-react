                ...
                <div className="flex flex-col gap-6">
                    <div className="bg-white/10 rounded-2xl shadow-xl p-6">
                        ...
                        <div className="mb-4">
                            ...
                            <select
                                className="w-full px-4 py-2 rounded-lg bg-white/5 text-white focus:outline-none focus:ring-2 focus:ring-indigo-400"
                                value={category}
                                onChange={(e) => setCategory(e.target.value)}
                                required
                            >
                                <option className="bg-transparent text-black" value="">Select a category</option>
                                {categories.map((cat) => (
