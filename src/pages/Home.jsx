  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-blue-900 via-purple-900 to-gray-900 overflow-hidden">
      ...
      <h1 className="text-5xl md:text-6xl font-extrabold text-white text-center mb-4 animate-fadeInUp">
        Where Ideas <span className="text-purple-400">Come to Life</span>
      </h1>
      <p className="text-lg md:text-xl text-gray-200 text-center mb-8 max-w-2xl animate-fadeInUp delay-100">
        Discover insightful articles, connect with passionate writers, and join
        a community of learners exploring the latest in technology, design, and
        innovation.
      </p>
      <div className="flex space-x-4 mb-12 animate-fadeInUp delay-200">
        <Link to="/login">
          <Button className="px-8 py-3 rounded-full font-semibold shadow-lg hover:scale-105 transition-transform duration-300">Sign In</Button>
        </Link>
        <Link to="/register">
          <Button className="px-8 py-3 rounded-full font-semibold shadow-lg hover:scale-105 transition-transform duration-300">
            Get Started
          </Button>
        </Link>
      </div>
      ...
      <div className="flex flex-wrap justify-center gap-8 mb-16 animate-fadeInUp delay-300">
        ...
        <div className="bg-white/10 rounded-xl px-8 py-6 text-center text-white shadow-lg">
          ...
          <div className="text-sm uppercase tracking-wider">Writers</div>
        </div>
        <div className="bg-white/10 rounded-xl px-8 py-6 text-center text-white shadow-lg">
          <div className="text-2xl font-bold mb-1">10K+</div>
          <div className="text-sm uppercase tracking-wider">Comments</div>
        </div>
        <div className="bg-white/10 rounded-xl px-8 py-6 text-center text-white shadow-lg">
